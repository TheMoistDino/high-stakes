...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2044.1135558475753; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1987.036071622651; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1282.860667718995; // x position of the perpendicular encoder (in tick units)
    }
